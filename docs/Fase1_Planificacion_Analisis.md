...
La entidad `Web_User` representa a cualquier persona registrada en la plataforma web "El Refugio". Estos usuarios tienen la capacidad de gestionar su perfil, acceder a funciones personalizadas y realizar interacciones como apadrinar un animal, ofrecerse para ser voluntarios, o acogedores. Los campos como `foster`, `volunteer`, y `sponsor` indican las áreas de interacción que el usuario puede tener con el refugio.

La entidad `Web_User` contiene los datos básicos de contacto y permite gestionar su rol y permisos. Los campos `foster`, `volunteer` y `sponsor` indican las áreas de interacción que el usuario puede tener con el refugio, como ofrecerse para acoger animales, colaborar como voluntario o apadrinar un animal.

Esta entidad se relaciona con otras funcionalidades del sistema, como las solicitudes de adopción o apadrinamiento, y los usuarios son la base para gestionar los accesos y permisos dentro de la plataforma.

| Field          | Data Type   | Description |
|----------------|-------------|-------------|
| `id_user`      | int         | Primary key, auto-generated by Laravel |
| `first_name`   | string      | User's first name |
| `last_name`    | string      | User's last name |
| `dni`          | string      | National ID (unique) |
| `email`        | string      | Email address (unique) |
| `phone`        | string      | Contact phone number |
| `address`      | string      | Residential address |
| `role`         | string      | User role: `admin`, `volunteer`, `user` |
| `password`     | string      | Hashed password (bcrypt) |
| `foster`       | boolean/null| Indicates if the user is interested in fostering animals |
| `volunteer`    | boolean/null| Indicates if the user wants to be a volunteer |
| `sponsor`      | boolean/null| Indicates if the user wants to sponsor animals |
| `created_at`   | timestamp   | Record creation date |
| `updated_at`   | timestamp   | Last modification date |

## **Entidad: Camp_User**

La entidad `Camp_User` representa a cualquier persona relacionada con el refugio que no necesariamente esté registrada en la plataforma web. Esta entidad incluye personas que pueden estar relacionadas con el refugio para funciones como adopciones, acogidas temporales o voluntariado, pero cuya información no requiere una cuenta en la web de la aplicación. Los datos de contacto de estas personas se registran para fines administrativos internos del refugio.
...
| `phone`          | string      | Contact phone number |
| `address`        | string      | Residential address |
| `role`           | string      | Type of user: `adopter`, `foster`, `volunteer`, etc. |
| `adopted_animal` | string/null | If applicable, ID of the adopted animal |
| `created_at`     | timestamp   | Record creation date |
| `updated_at`     | timestamp   | Last modification date |
...
| `adopted_date`   | date/null   | Fecha en que fue adoptado, si aplica |
| `adopted_by_dni` | string/null | DNI de la persona adoptante (aunque no sea usuaria registrada) |
